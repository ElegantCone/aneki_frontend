    ...
    jokes: [
        {
            ...
            userId: 'u-demo-1',
            content:
                'Почему программисту не страшен понедельник? Он и так живет в состоянии perpetual beta.',
        ...
        },
        {
            ...
            userId: 'u-demo-2',
            content:
                'Сисадмин говорит: "У нас всё работает". Пользователи отвечают: "Тогда почему мы можем работать?"',
